...
parser.add_argument("-i", "--input-directory", metavar ='', type = str, help = "Directory where your Markdown files are")
parser.add_argument("-o", "--output-directory", metavar = '', type = str, help = "Directory in which you wish to place your HTML files")
